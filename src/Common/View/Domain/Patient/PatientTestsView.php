...
namespace Juancrrn\Reacsampler\Common\View\Domain\Patient;
...
class PatientTestsView extends ViewModel
{

    private const VIEW_RESOURCE_FILE    = 'domain/patient/view-patient-tests';
