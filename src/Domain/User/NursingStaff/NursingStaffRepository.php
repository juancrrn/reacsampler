...
class NursingStaffRepository extends UserRepository
{

    private static function createModelFromMysql(object $mysqli_object): NursingStaff
    {
        $birthDate =
     ...
     */
    public function completeModel(object $mysqli_object): NursingStaff
    {
        $query = <<< SQL
        SELECT
            collegiate_number
